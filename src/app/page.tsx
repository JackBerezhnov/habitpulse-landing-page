    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-black relative overflow-hidden">
      ...
      <section className="py-20 bg-gradient-to-r from-purple-600 via-pink-600 to-cyan-500 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-white text-purple-600 px-5 py-4 rounded-xl text-lg font-black hover:scale-110 transition-all duration-300 shadow-2xl shadow-white/25 border-2 border-white">
              ⚡ JOIN THE BETA FREE
            </button>
