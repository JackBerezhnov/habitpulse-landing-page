      ...
      <nav className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <a href="https://www.habit-pulse.com/blog" className="text-gray-300 hover:text-cyan-400 transition-colors font-medium relative z-20 cursor-pointer" style={{pointerEvents: 'auto'}}>
              Blog
            </a>
            <a href="https://discord.gg/SDjprAkATd" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-cyan-400 transition-colors font-medium flex items-center space-x-2 relative z-20 cursor-pointer" style={{pointerEvents: 'auto'}}>
